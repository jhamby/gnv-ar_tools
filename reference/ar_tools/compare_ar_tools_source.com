$! File: compare_ar_tools_source.com
$!
...
$!
$! By default:
$!    The source directory is source_root:[ar_tools.reference.ar_tools],
$!    the logical used on my system for the GNV Mecurial repository checkout.
$!    If source_root: is not defined, then src_root:[ar_tools] will be
$!    translated to something like DISK:[dir.ar_tools.reference.ar_tools]
$!    and then DISK:[dir.ar_tools.vms_source.ar_tools] will be used.
$!
$!    The copy directory is vms_root:[ar_tools]
...
$!     The source directory tree is: src_root:[ar_tools]
$!     The copy directory is src_root1:[ar_tools]
$!
$!   src_root1:[ar_tools] is used by me to work around that VMS backup will
...
$!    The source directory is vms_root:[ar_tools]
$!    The copy directory is vms_root1:[ar_tools]
$!
$!   vms_root:
$!   src_root1:[ar_tools] is used by me to work around that VMS backup will
$!   not use NFS as a source directory so I need to make a copy.
...
$if p1 .eqs. "SRCBCK"
$then
$   ref_base_dir = "ar_tools"
$   wrk_base_dir = "ar_tools"
$   ref = "src_root:[" + ref_base_dir
$   wrk = "src_root1:[" + wrk_base_dir
$   if update_file
$   then
$       if f$search("src_root1:[000000]ar_tools.dir") .eqs. ""
$       then
$           create/dir/prot=o:rwed src_root1:[ar_tools]
$       endif
$   endif
$endif
$!
...
$   if update_file
$   then
$       if f$search("vms_root1:[000000]ar_tools.dir") .eqs. ""
$       then
$           create/dir/prot=o:rwed vms_root1:[ar_tools]
$       endif
$   endif
$endif
$!
