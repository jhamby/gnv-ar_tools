$! File: build_ar_tools_pcsi_text.com
$!
$! Build the *.pcsi$text file from the four components:
$!    1. Generated =product header section
$!    2. readme. file from the Ar_tools distribution, modified to fit
$!       a pcsi$text file format.
$!    3. copying file from the Ar_tools distribution, modified to fit
$!       a pcsi$text file format.
...
$!
$!
$! 25-Jul-2014  J. Malmberg - Ar_tools version
$!
$!===========================================================================
$!
