$! File: build_ar_tools_pcsi_desc.com
$!
...
$!
$! The file pcsi_ar_tools_file_list.txt is read in to get the files other
...
$! Fortunately AR_TOOLS does not trip most of these issues, so those steps
...
$!---------------------------------------------------------------------
$ open/read flst pcsi_ar_tools_file_list.txt
$!
$inst_alias_loop:
...
$! remove aliases
$   line_out = -
       "  ""@pcsi$destination:[gnv.vms_bin]ar_tools_alias_setup.com remove"""
$   i = 0
$ex_rem_loop:
...
$       write pdsc line_out
$   endif
$   line_out = "  ""@pcsi$destination:[gnv.vms_bin]remove_old_ar_tools.com"","
$   write pdsc line_out
$   line_out = "  ""@pcsi$destination:[gnv.vms_bin]ar_tools_alias_setup.com"""
$   i = 0
$ex_pins_loop:
$       line = f$element(i, ",", add_alias_lines)
$       i = i + 1
...
$!   Add [.SYS$STARTUP]gnv$ar_tools_startup file
$!---------------------------------------
$ write pdsc "   file ""[sys$startup]gnv$ar_tools_startup.com"""
$ write pdsc "     source [vms_bin]gnv$ar_tools_startup.com ;"
$!
$!   Add Release notes file.
$!------------------------------
$ write pdsc -
